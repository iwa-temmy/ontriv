    ...
    return (
      <>
        <div className='dashboard dashboard-wrapper px-2'>
          <Row>
            <Col xl='8' className=''  >
              <div className='bg-white rounded-2 py-4 px-5' style={{ borderRadius: "10px" }}>
                  ...
                  <div className='d-inline-flex mb-5 w-100'>
                    <div className='me-auto'>
                      <div className='d-inline-flex w-full'>
                        ...
                        <h6 className='add-item ms-3 me-auto my-auto'>Dowload Invoice</h6>
                      </div>
              ...
              <div className='bg-white rounded-2 py-4 px-5 mt-5' style={{ borderRadius: "10px" }}>
                <h6 className='add-item fs-5'>
                  Invoice Payment
                </h6>
                <Row className='mt-3'>
                  <Col xl='3'>
                    <h6  className='fs-6 text-black-50'>
                      Client
                    </h6>
                  </Col>
                  <Col xl='3'>
            ...
            <Col xl='4' >
              <div className='d-inline-flex w-10t'>
                ...
                <h6 className='blue-btn py-2 px-4'>
                  More Actions
                </h6>
              </div>
              {
                showOptions? <div className='more-actions-container'>
              ...
              <div className='my-4 py-2 px-2 bg-white'>
                <div className='light-blue-bg d-inline-flex w-100 px-3 py-3'>
                  <h6 className='my-auto fw-light slightly-black'>Lorem ipsum dolor sit amet, </h6>
                  <img src={LockKey} className='ms-auto' alt=""/>
                </div>
              </div>
              <h6 className='py-3 text-center px-4 send w-100 mb-4' style={{ textAlign: "center"}}>
                Make Recurring
              </h6>
              <h6 className='blue-btn py-3 px-4'>
                Preview as Client
              </h6>
            </Col>
          </Row>
