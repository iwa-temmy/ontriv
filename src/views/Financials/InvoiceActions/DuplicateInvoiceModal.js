...
const DuplicateInvoiceModal = ({ showDuplicateInvoiceModal, setShowDuplicateInvoiceModal}) => {
  return (
    <Modal modalState={showDuplicateInvoiceModal} setModalState={setShowDuplicateInvoiceModal}>
