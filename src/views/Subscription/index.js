                    ...
                    <div>
                      ...
                      <Row>
                        ...
                        >
                          <div className="subscription__card__border">
                            <div
                              className={`subscription__card__content subscription__card__content__plan px-4 ${
                                durationState === "year"
                                  ? "subscription__card__content__active"
                                  : ""
                              }`}
                            >
                              ...
                              >
                                ...
                                <h6 className="subscription__card__content__price-text mt-2">
                                  $
                                  {(pricing.plan[planState] * 12 * 0.8).toFixed(
                                    2
                                  )}
                                  /
                                  <span className="subscription__card__content__price-text__duration">
                                  ...
                                  <br />
                                  <span className="subscription__card__content__price-text__subscript ml-auto">
                                    Save 20%
                                  </span>
                                </h6>
                              </div>
