                ...
                <Col sm='12' md='3' className='mb-4' >
                    <Card className='grid-view-card'>
                        <div className='client-details d-flex  align-items-center'>
                            ...
                            <div>
                                <h1 className='client-name mb-0'>Digital Seed</h1>
                        ...
                        <div className='d-flex justify-content-between project-details align-items-center'>
                            <div>
                                <h1 className='project-timeline-header'>
                                    Project Timeline
                                </h1>
                                <p className='project-timeline'>6 Months</p>
                            </div>
                            <div>
                                <h3 className='date-created-header'>
                                    Date Created:
                                </h3>
                                <p className='date-created'>12/04/21</p>
                            </div>
                        </div>
                        <div>
                        </div>
