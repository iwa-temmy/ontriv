...
const FineTuneFacebook = ({socialchannel,setOpenModal,activeTab,setActiveTab,index}) => {
  ...
  return (
    <Row>
      ...
      <Col  xs="12"
          ...
          sm="12">
      <div>
      <DatePicker className='datePickerStyle' placeholderText="Facebook date & time  " selected={startDate} onChange={(date) => setStartDate(date)} /><br/><br/>
