...
const Team = () => {
  ...
  return (
    <div className="mb-0 mt-2 overflow-auto team-section">
      <div className='header-section my-3 d-flex align-items-center justify-content-between px-4 '>
        <h1>Team Members</h1>
        <div className='btn-lg  create-button align-items-center cursor-pointer '
          onClick={() => {
            setAddState(true)
          }}
        >
      ...
      <Table columns={cols} data={teamMembers} divided shadow defaultPageSize={6} pagePosition='center' />
      <NewTeamMember
        addState={addState}
